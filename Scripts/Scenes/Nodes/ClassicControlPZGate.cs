...
[GlobalClass, Tool]
public partial class ClassicControlPZGate : GraphNode, ISaveableGate, ICompileableGateWithBits, IColorableGate
{
    ...
    public LazyMatrix compile(int QBitCount, Array<int> ForQBits, Array<int> classicBits, ClassicControlBitMatrix.GetMatrixIndexByBits getter)
    {
        ...
        var bit = ForQBits[0];
        var Matrix = new ClassicControlBitMatrix(new IMatrix[] {GateBuilder.Identity(1), GateBuilder.PauliZ()}, classicBits.ToArray(), getter);
